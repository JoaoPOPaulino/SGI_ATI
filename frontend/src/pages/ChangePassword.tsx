      ...
      <div className="w-full max-w-[440px] bg-white rounded-3xl shadow-xl p-8 border border-gray-100 animate-slide-up">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 space-y-2">
            <p className="text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">Requisitos da senha</p>
            ...
            <div className="flex items-center gap-2 text-xs text-gray-500">
              <CheckCircle2 size={14} className={/[^a-zA-Z0-9]/.test(senhaNova) ? "text-green-500" : "text-gray-300"} />
