    ...
    <>
      ...
      >
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden">
          <div
            className="absolute top-[5%] left-[5%] w-[500px] h-[500px] rounded-full blur-3xl mix-blend-multiply"
            style={{
              background:
          ...
          />
          <div
            className="absolute bottom-[5%] right-[5%] w-[450px] h-[450px] rounded-full blur-3xl mix-blend-multiply"
            style={{
              background:
          ...
          />
          <div
            className="absolute top-[40%] left-[40%] w-[400px] h-[400px] rounded-full blur-3xl mix-blend-multiply"
            style={{
              background:
