...
const statusStyle: Record<string, { bg: string; text: string; border: string; dot: string; label: string; pulse?: boolean }> = {
  ...
  REGULAR:          { bg: 'bg-sky-50',      text: 'text-sky-700',      border: 'border-sky-300',      dot: 'bg-sky-500',      label: 'Regular'                },
  BOM:              { bg: 'bg-sky-50',      text: 'text-sky-700',      border: 'border-sky-300',      dot: 'bg-sky-500',      label: 'Regular'                },
