...
const itens = [
  ...
  { nome:'Mousepad Havit MP900', tipo:'NAO_SERIALIZADO', categoria:'ACESSORIO', condicao:'USADO', status:'ATIVO', localizacao_atual:'Bloco A - 3 Andar - TI - 302', polo:'GSM', predio:'Bloco A', andar:'3 Andar', setor:'TI', sala:'Sala 302', marca:'Havit', modelo:'MP900', quantidade:12 },
  { nome:'Mouse Logitech M100', tipo:'NAO_SERIALIZADO', categoria:'ACESSORIO', condicao:'USADO', status:'ATIVO', numero_serie:'SN-LOG-001', localizacao_atual:'Lab', polo:'Laboratório', predio:'Bloco B', andar:'1 Andar', setor:'Infraestrutura', sala:'Lab', marca:'Logitech', modelo:'M100', quantidade:5 },
  { nome:'Cabo HDMI 2m', tipo:'NAO_SERIALIZADO', categoria:'ACESSORIO', condicao:'USADO', status:'ATIVO', localizacao_atual:'Oficina', polo:'Laboratório', predio:'Bloco B', andar:'Térreo', setor:'Manutencao', sala:'Oficina', marca:'Generico', modelo:'HDMI 2m', quantidade:20 },
  { nome:'Fonte ATX 500W', tipo:'NAO_SERIALIZADO', categoria:'ACESSORIO', condicao:'NOVO', status:'ATIVO', localizacao_atual:'Lab', polo:'Laboratório', predio:'Bloco B', andar:'1 Andar', setor:'Infraestrutura', sala:'Lab', marca:'Corsair', modelo:'VS500', quantidade:3 },
];
